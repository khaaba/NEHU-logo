...
% University logo -- NORTH-EASTERN HILL UNIVERSITY (NEHU)
% LAIRENLAKPAM JOYPRAKASH SINGH, MANIPUR
...
%------------------------------------------------------------
%
% for Hindi Characters
%------------------------------------------------------------
\usepackage{polyglossia} % XeLaTeX
\usepackage{fontspec}
\setdefaultlanguage{english}
\setotherlanguage{hindi}
%\setotherlanguage{eyek}
\newfontfamily\hindifont[Script=Devanagari]{Shree Devanagari 714}
%------------------------------------------------------------
%------------------------------------------------------------
...
%				text={%
%					|\fontsize{18pt}{2em}\bf\rmfamily\selectfont| % any size
...
%				},
%			decorate
%			}, text effects={scale text to path}%, scale=1
%		] (-20:3cm) arc (-20:180:2.6cm);  
\path[%double distance=10mm,
% line width=2pt,
% draw=yellow,
postaction={%
decorate, 
...
text along path,
text align={center},
text={|\LARGE\bfseries\rmfamily|NORTH-EASTERN HILL UNIVERSITY}
		}, %https://tex.stackexchange.com/a/381266
	},
] (-90:40mm) arc (270:-90:3.5cm);
%{\normalfont\hindifont{\small पूर्वोत्तर-पर्वतीय विश्वविद्यालय}}
\path[%double distance=10mm,
% line width=2pt,
% draw=yellow,
postaction={%
...
text along path,
text align={center},
text={|\bfseries\huge\hindifont\color{blue!65!green}| {पू}{र्वो}{त्त}{र}-{प}{र्व}{ती}{य} {वि}{श्व}{वि}{द्या}{ल}{य}}
		}, %https://tex.stackexchange.com/a/368524
	},
] (-90:38mm) arc (270:-90:3.5cm);
...
% Book
	...
	%
	\node at (-1.1, 0.81)[scale=1]{%
	\begin{tikzpicture}%[minimum width=40]
	\path [decorate,decoration={text along path,pre length=1em,post length=1em,
		text align={align=fit to path stretching spaces}, 
		text={|\fontsize{8}{4.8}\selectfont % उठो और निर्माण करो
			\hindifont\bfseries\color{blue}|{उ}{ठो} {औ}{र}}}]
		(-2.1, 1.1) to [out=-0, in=205] (-1.2,1.14) to [out=25, in=145] (0, 1.0);
	\end{tikzpicture}};
	\node at (-1.2, 0.45)[scale=1]{%
	\begin{tikzpicture}%[minimum width=40]
	\path [decorate,decoration={text along path,pre length=1.5em,post length=1em,
		text align={align=fit to path stretching spaces}, 
		text={|\fontsize{8}{4.8}\selectfont
			\bfseries\hindifont\color{blue}| {नि}{र्मा}{ण} {क}{{रो}} }}] 
		(-2.1,1.07) to [out=-25, in=205] (-1.2,1.14) to [out=25, in=145] (0,1.0);
	\end{tikzpicture}};
	\node at (1.6, 0.75)[scale=1]{%
	\begin{tikzpicture}%[minimum width=40]
	\path [decorate,decoration={text along path, pre length=5.4em, post length=1em,
		text align={align=fit to path stretching spaces}, 
		text={|\fontsize{8}{4.8}\selectfont
			\bf\sffamily\color{blue}\selectfont|RISE UP}}] 
		to (0.3, 0.6) to  [out=50, in=170]  (1.3, 0.65) to [out=-20, in=200] (2.7, 0.6);
	\end{tikzpicture}};
	\node at (1.35, 0.42)[scale=1]{%
	\begin{tikzpicture}%[minimum width=40]
	\path [decorate,decoration={text along path, pre length=7em,post length=1em,
		text align={align=fit to path stretching spaces}, 
		text={|\fontsize{8}{4.8}\selectfont
			\bfseries\sffamily\color{blue}| AND BUILD}}]
		to (0.3, 0.4) to [out=40, in=170] (1.3, 0.65) to [out=-20, in=190] (2.7, 0.4);
	\end{tikzpicture}};
	\end{tikzpicture}};
\end{tikzpicture}
\end{document}
